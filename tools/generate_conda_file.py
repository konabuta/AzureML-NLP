...
PIP_BASE = {
    ...
    "azureml-sdk": "azureml-sdk[automl,notebooks,contrib]==1.2,0",
    "azureml-train-automl": "azureml-train-automl==1.2.0",
    "azureml-dataprep": "azureml-dataprep==1.2.0",
    "azureml-widgets": "azureml-widgets==1.2.0",
    "azureml-mlflow": "azureml-mlflow==1.2.0",
    "black": "black>=18.6b4",
    ...
    "mecab-python3": "mecab-python3==0.996.5",
}
